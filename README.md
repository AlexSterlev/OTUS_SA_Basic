...
<tr><td rowspan="5" valign="top"></td><td rowspan="5" valign="top"><i>Безопасность:</i></td><td valign="top"><i>Резервное копирование базы (инкрементное) каждые 5 минут</i></td><td rowspan="5" valign="top"><i>Нефункциональное</i></td><td rowspan="5" valign="top"></td></tr>
