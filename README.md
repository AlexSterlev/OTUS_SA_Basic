...
- #### Критерии приёмки: ####
- Менеджер может открыть список свободных мастеров через интерфейс управления заказами/нарядами.
- В списке отображаются только те мастера, которые в данный момент не заняты другими задачами.
